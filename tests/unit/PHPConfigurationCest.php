...
class PHPConfigurationCest
{
    ...
    public function checkPHPConfig_expose_php(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep expose_php");
    ...
    public function checkPHPConfig_enable_dl(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep enable_dl");
    ...
    public function checkPHPConfig_allow_url_fopen(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep allow_url_fopen");
    ...
    public function checkPHPConfig_allow_url_include(UnitTester $I){
        ...
        $I->runShellCommand("docker exec prod_web_ubuntu php -i | grep allow_url_include");
